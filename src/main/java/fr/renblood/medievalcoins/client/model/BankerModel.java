package fr.renblood.medievalcoins.client.model;// Made with Blockbench 4.5.2
...
public class BankerModel<T extends Banker> extends EntityModel<T> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(MedievalCoin.MODID, "banker"), "main");
    ...
    public BankerModel(ModelPart root) {
